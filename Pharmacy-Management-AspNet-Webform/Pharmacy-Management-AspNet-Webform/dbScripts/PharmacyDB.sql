...
CREATE PROCEDURE sp_GetMedicinesForDropdown
AS
BEGIN
...
CREATE PROCEDURE sp_CheckMedicineStock
    @Id INT
AS
BEGIN
...
CREATE PROCEDURE sp_InsertSalesMaster
...
CREATE PROCEDURE sp_InsertSalesDetail
    @InvoiceId INT,
    @MedicineId INT,
    @BatchNo NVARCHAR(50),
    @ExpiryDate DATE,
